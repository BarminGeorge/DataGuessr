...
public class PlayerRepositoryTestContext : DbContext, IDataContext
{
    ...
    public PlayerRepositoryTestContext(DbContextOptions<PlayerRepositoryTestContext> options)
        : base(options) { }
